...
public class ImageCardAdapter extends BaseAdapter {
    ...
    private List<ImageState> mCards;
    private ExplosionField mExplosionField;
    private int clicked;
    private long lastTimeClicked;
    private Map.Entry<FlipImageView3D, ImageState> currentSelection;
    ...
    public void populateCards(boolean reset) {
        ...
        RealmResults<ImageState> result = realmDb.where(ImageState.class).findAll();
        ...
        if(mCards.size() == 0 || reset) {
            ...
            for (int i = 0; i < content.size(); i++) {
                ImageState card = new ImageState();
                card.setPosition(i);
                card.setGone(false);
    ...
    private class CardClickListener implements View.OnClickListener {
        ...
        private ImageState selectedCard;

        public CardClickListener(FlipImageView3D flip_3d, ImageState selected_card) {
            this.flip3D = flip_3d;
        ...
        public void onClick(final View v) {
            ...
            if(gameCardCount == 0)
                return;
            ImageState previous_card = (currentSelection != null) ? currentSelection.getValue() : null;
            if(currentSelection == null) {
                ...
                final Map.Entry<FlipImageView3D, ImageState> selection = currentSelection;
                currentSelection = null;
