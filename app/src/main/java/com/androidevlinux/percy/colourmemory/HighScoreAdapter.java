...
public class HighScoreAdapter extends BaseTableAdapter {
    ...
    private List<GameHighScore> userScores;
    ...
    public boolean populateScore() {
        RealmResults<GameHighScore> result = realmDb.where(GameHighScore.class).findAll();
    ...
    public View getView(int row, int column, View convertView, ViewGroup parent) {
        ...
        switch (getItemViewType(row, column)) {
            ...
            case 1:
                ...
                break;
            default:
                throw new RuntimeException("RuntimeException HighScore getView");
        }
        return view;
    }
    ...
    private View getBody(int row, int column, View convertView, ViewGroup parent) {
        ...
        switch(column+1) {
            ...
            case 2:
                ...
                break;
            default:
                throw new RuntimeException("RuntimeException HighScore getBody");
        }
